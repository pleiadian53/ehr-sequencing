...
**Your benchmark script will show Med2Vec quality by comparing:**

```
Experiment 1: From scratch    → Final accuracy: 40-50%
Experiment 2: Med2Vec init    → Final accuracy: 50-60%
Experiment 3: External init   → Final accuracy: 45-55%

Med2Vec improvement: +10-15% absolute (25-30% relative)
```

**If Med2Vec gives 10%+ improvement, it's high quality.**
