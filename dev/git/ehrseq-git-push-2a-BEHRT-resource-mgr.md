...
```
Commit: fcf8235
Message: Add PyHealth benchmarking infrastructure with adapter pattern and optional dependencies
Files: 17 changed, 5192 insertions(+)
```

**What was committed:**
- 🏗️ Core benchmarking module (`src/ehrsequencing/benchmarks/`)
- 🔌 PyHealth adapter with base interface
- 📊 ModelComparator and UnifiedMetrics
- 📝 Example script and documentation
- 🌍 Optional environment file + updated main environment.yml

All changes are now on `origin/main`. 🚀