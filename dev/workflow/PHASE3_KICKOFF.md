...
1. Create `examples/pretrain_finetune/train_behrt_demo.py` (small model)
2. Create `examples/pretrain_finetune/train_behrt.py` (production with 3 sizes)
...
- `examples/pretrain_finetune/train_behrt_demo.py` - Demo training script
- `examples/pretrain_finetune/train_behrt.py` - Production training script
