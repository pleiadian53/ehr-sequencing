...
**Scripts to create**:
- Local: `examples/pretrain_finetune/train_patient_lstm_local.py`
- RunPods: `examples/pretrain_finetune/train_patient_lstm_runpods.py`
- RunPods: `examples/pretrain_finetune/train_patient_transformer_runpods.py`
- RunPods: `examples/pretrain_finetune/train_behrt_runpods.py`
