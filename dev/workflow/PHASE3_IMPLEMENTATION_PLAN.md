...
- `examples/encoders/train_behrt_demo.py` - Small model demo
- `examples/encoders/train_behrt.py` - Production training
...
- `examples/encoders/train_transformer_demo.py` - Small model demo
- `examples/encoders/train_transformer.py` - Production training
...
- [ ] Create `examples/encoders/train_behrt_demo.py`
  - Small model, quick iteration
  - MLM pre-training
  - Minimal configuration
- [ ] Create `examples/encoders/train_behrt.py`
...
```bash
# On RunPods A40
python examples/encoders/train_behrt.py \
...
- [ ] Training scripts in `examples/encoders/`
