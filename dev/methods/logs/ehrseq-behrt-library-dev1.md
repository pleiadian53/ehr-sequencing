...
Would be great to integrate the benchmarking workflows defined in the example script: examples/pretrain_finetune/benchmark_pretrained_embeddings.py and make them resuable also under src/ehrsequencing/benchmarks/ 
