...
- ✅ You actively develop/debug code on the pod
- ✅ You make frequent code changes during training experiments
- ✅ You want bidirectional sync with version control
- ✅ Multiple people work on same pod

Use rsync if:
- ✅ You develop entirely locally
- ✅ Pod is only for training (code doesn't change)
- ✅ Simple one-way sync is sufficient
