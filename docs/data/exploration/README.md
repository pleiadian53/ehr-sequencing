...
- [Synthea Setup](../../setup/synthea_setup.md) - Synthea data generation
...
> **Also in notebooks context**: This document is mirrored from [`notebooks/01_synthea_data_exploration/README.md`](../../notebooks/01_synthea_data_exploration/README.md), which includes the runnable notebooks alongside this documentation.
