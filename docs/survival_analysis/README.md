...
- Check `../methods/` for detailed methodology
- Review `../data/exploration/` for data pipeline basics
...
> **Also in notebooks context**: This document is mirrored from [`notebooks/02_survival_analysis/README.md`](../notebooks/02_survival_analysis/README.md), which includes the runnable notebooks alongside these tutorials.
