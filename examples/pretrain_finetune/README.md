# BEHRT Pre-training and Fine-tuning

This directory demonstrates two workflows for training BEHRT (BERT for EHR): pre-training from scratch and fine-tuning with pre-trained embeddings. Includes LoRA for efficient fine-tuning and comprehensive experiment tracking for ephemeral GPU pods.
